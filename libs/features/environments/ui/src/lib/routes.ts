...
export const environmentRoutes: Routes = [
  { path: '', children: [
    { path: 'view', loadComponent: () => import('./components').then((m) => m.EnvironmentViewComponent), data: { title: 'environment.view.title' }, children: [
      ...
      { path: ':id', resolve: { environment: environmentRouteResolver }, children: [
        { path: 'edit', loadComponent: () => import('./components').then((m) => m.EnvironmentsDialogComponent),  data: { title: 'container.edit.title', dialogComponent: EnvironmentsEditComponent } },
      ] },
    ] },
