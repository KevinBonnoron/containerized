...
import { Observable, catchError, distinctUntilChanged, filter, of, pipe, shareReplay, switchMap, tap } from 'rxjs';
  ...
  return signalStoreFeature(
    ...
    withMethods((store) => {
      ...
      return {
        ...
        update: rxMethod<T>(
          switchMap((entity) =>
            service.update(selectEntityId(entity), entity).pipe(
